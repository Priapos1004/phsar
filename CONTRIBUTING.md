...
- **[`docs/features/`](docs/features/)** describes how each subsystem works today, across the modules it spans — one doc per subsystem, indexed with a line on each in [CLAUDE.md](CLAUDE.md). Start here for "how does X work". `compound-docs/` records *why* something changed; the feature docs record how it works now.
