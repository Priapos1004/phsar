...
| **v0.12.0** | User settings + user page UI + data export + admin | Settings table, profile pictures, rating step, name language, spoiler protection. Download own ratings/watchlist data. Token expiry dialog. Registration page. Guest account. Admin page for registration token management. |
